...
export default function ProcessBlueprint() {
  return (
    <section className="py-16 px-4 relative overflow-hidden" data-testid="section-process-blueprint">
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 relative z-10">
            ...
            >
              ...
              <p className="font-medium text-sm">Find the Right Stylist</p>
          ...
          <div className="flex justify-center mt-10">
            <Link href="/upload">
              <Button size="lg" className="rounded-full" data-testid="button-create-look-process">
                Create Your Look
