...
async function callBiSeNetPipeline(
  imageBase64: string,
  mode: "hair_only" | "hair_only_simple" | "hair_only_ultra" | "reference" | "reference_face_masked" | "facial_features_only" | "hair_with_skin_border",
  bufferPx: number,
    ...
    python.on('close', (code) => {
      ...
      try {
        ...
        if (output.success) {
          ...
          if (mode === "hair_only" || mode === "hair_only_simple" || mode === "hair_only_ultra") {
